...
function App() {
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 mt-40 bg-gray-800 text-yellow-400">
      <h1 className='text-white text-2xl text-center my-3'>Password Generator</h1>
    <div className="flex shadow rounded-lg overflow-hidden mb-4">
        <input
            type="text"
            value={password}
            className="outline-none w-full py-1 px-3 text-red-600"
